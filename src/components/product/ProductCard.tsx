  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute top-2 right-2 z-20 w-7 h-7 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center shadow-sm hover:bg-white transition-colors"
      >
        <Heart size={13} className={isWished ? "text-[#E63946] fill-[#E63946]" : "text-[#888]"} />
      </button>
    </div>
  );
}
